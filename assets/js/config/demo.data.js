/**
 * demo.data.js — داده‌های نمایشی NadStore (بدون نیاز به بک‌اند)
 */

const IMG = (n) => `assets/images/products/p${n}.jpg`;
...
function makeProduct({
  id, name, slug, price, categoryId, categoryName, categorySlug,
  featured = false, stock = 12, imageNum = id,
}) {
