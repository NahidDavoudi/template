 ...
 * store.config.js — تنظیمات yoozstar یوز استار (قالب نمایشی)
...
export default {
  ...
  texts: {
    ...
    footer: {
      ...
      tagline: 'yoozstar یوز استار — فروشگاه آنلاین',

      support: 'پشتیبانی ۷ روز هفته',

      social: '@yoozstar',

      copyright: '© ۱۴۰۴ yoozstar یوز استار',
    ...
    legal: {
      ...
      about: {
        ...
        meta: 'آشنایی با yoozstar یوز استار — قالب فروشگاه آنلاین برای نمایش UI و تجربه کاربری.',

        title: 'درباره ما',

        subtitle: 'yoozstar یوز استار؛ قالب آماده فروشگاه آنلاین.',

        icon: 'sparkles',

        intro: 'yoozstar یوز استار یک قالب فروشگاه آنلاین فارسی‌زبان است که برای نمایش، پیش‌نمایش و توسعه فرانت‌اند طراحی شده. شامل صفحات محصول، سبد خرید، تسویه حساب، پروفایل و صفحات قانونی است. در حالت نمایشی، تمام داده‌ها به‌صورت محلی بارگذاری می‌شوند و نیازی به سرور ندارند.',

        sectionTitles: {

          intro: 'معرفی yoozstar یوز استار',

          mission: 'مأموریت ما',

          vision: 'چشم‌انداز ما',

          whyChooseUs: 'چرا yoozstar یوز استار؟',

          stats: 'yoozstar یوز استار در یک نگاه',
      ...
      contact: {
        ...
        meta: 'راه‌های ارتباطی با فروشگاه yoozstar یوز استار — تلفن، ایمیل، آدرس، ساعات کاری و فرم تماس برای پشتیبانی و سوالات.',

        title: 'تماس با ما',

        subtitle: 'تیم پشتیبانی yoozstar یوز استار آماده پاسخگویی به سوالات شما درباره محصولات، سفارشات و همکاری است.',
        ...
        email: { label: 'ایمیل', value: 'hello@yoozstar.com', note: 'پاسخ‌دهی در حالت نمایشی غیرفعال است' },
      ...
      terms: {
        ...
        meta: 'قوانین و مقررات استفاده از فروشگاه آنلاین yoozstar یوز استار — شرایط سفارش، پرداخت، تعهدات طرفین و حقوق مالکیت معنوی.',
        ...
        sections: [

          {
            ...
            content: [
              ...
              'منظور از «فروشگاه» وب‌سایت yoozstar یوز استار و کلیه خدمات آنلاین مرتبط است. «کاربر» هر شخصی است که از خدمات فروشگاه استفاده می‌کند.',
...

          {
            ...
            content: [
              ...
              'کلیه محتوای وب‌سایت شامل لوگو، تصاویر، طراحی‌ها، متون و نام تجاری yoozstar یوز استار تحت حمایت قوانین مالکیت فکری است.',
            ...
            items: [
              ...
              'طراحی‌های اختصاصی yoozstar یوز استار متعلق به این برند است.',
      ...
      privacy: {
        ...
        meta: 'سیاست حریم خصوصی yoozstar یوز استار — نحوه جمع‌آوری، استفاده، نگهداری و حفاظت از اطلاعات شخصی کاربران.',
        ...
        sections: [
...

          {
            ...
            content: [
              ...
              'وب‌سایت yoozstar یوز استار از کوکی‌ها و فناوری‌های مشابه برای بهبود عملکرد و حفظ وضعیت ورود شما استفاده می‌کند.',
      ...
      refund: {
        ...
        meta: 'شرایط بازگشت وجه و لغو سفارش در فروشگاه yoozstar یوز استار — قوانین مرجوعی، تعویض و رسیدگی به کالای آسیب‌دیده.',
        ...
        sections: [
...

          {
            ...
            items: [
              ...
              'بررسی کیفیت توسط تیم yoozstar یوز استار.',
      ...
      faq: {
        ...
        meta: 'پاسخ سوالات متداول درباره خرید، ارسال، پرداخت، سایزبندی و مرجوعی در فروشگاه آنلاین لباس yoozstar یوز استار.',
        ...
        items: [
          ...
          { question: 'آیا محصولات اورجینال هستند؟', answer: 'تمام محصولات yoozstar یوز استار تولید اختصاصی یا تأمین‌شده از منابع معتبر هستند و پیش از ارسال کنترل کیفیت می‌شوند.' },
    ...
    newsletter: {
      ...
      title: 'عضویت در خبرنامه yoozstar یوز استار',
